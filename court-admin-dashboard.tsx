...
import { FileText, Users, Calendar, Clock, AlertCircle, Check, X, FileCheck, ArrowRight, Database, BarChart2, Clipboard, Settings, Bell, Search, Filter, Download, ChevronDown, BookOpen, PlusCircle, Edit, Trash2, Eye, Printer } from 'lucide-react';
    ...
    return (
      <div className="h-full flex flex-col">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-sm text-gray-500">Filing #{selectedFiling.id}</span>
        </div>
            ...
            <div className="h-full flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-lg shadow p-4">
                  ...
                  <button className="w-full mt-3 py-2 text-sm text-blue-600 bg-blue-50 rounded-lg">View All Hearings</button>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-4">
                  ...
                  <button className="w-full mt-3 py-2 text-sm text-blue-600 bg-blue-50 rounded-lg">View Court Schedule</button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 mb-6">
                <div className="bg-white rounded-lg shadow p-4">
                  ...
                  <div className="flex flex-col items-center p-4">
                    <div className="h-20 w-20 rounded-full bg-[#1a4699] text-white flex items-center justify-center text-xl font-bold mb-3">
                      CA
                    </div>
                    <h4 className="font-medium">Court Administrator</h4>
                    <p className="text-sm text-gray-500">admin@courtsystem.gov</p>
                    <button className="mt-4 text-sm text-[#1a4699] font-medium">Edit Profile</button>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-4">
                  ...
                  <div className="space-y-3">
                    <button className="w-full p-2 text-sm bg-gray-100 rounded">Change Password</button>
                    <button className="w-full p-2 text-sm bg-gray-100 rounded">Enable 2FA</button>
                    <button className="w-full p-2 text-sm bg-gray-100 rounded">Manage API Keys</button>
                  </div>
                </div>
              </div>
